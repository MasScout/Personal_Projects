...
main:        @Must use this label where to start executing the code. 
    ...
    MOV   r2, #0x29    @ Length of string to print (in Hex).
...
string1: .asciz "My full name is Mason Alexander Barrow.\n"  @Length 0x26

.balign 4   @ Force a word boundry
string2: .asciz "My UAH email address is mab0086@uah.\n" @Length 0x23

.balign 4   @ Force a word boundry
string3: .asciz "This is my first ARM assembly program for CS309-1 2020-21.\n" @Length 0x39
